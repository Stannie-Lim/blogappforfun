...
import {
  useTheme
} from "./chunk-EKQQSVUU.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-3K6BTF77.js";
import {
  HTMLElementType,
  _extends,
...
function useButton(parameters = {}) {
  ...
  const updateHostElementName = React19.useCallback((instance) => {
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React56.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React56.useRef(false);
  const handleEntering = React56.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React56.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React56.useCallback(() => {
    dispatch("exiting");
  }, []);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime33.jsx)(React61.Fragment, {
...
function useTabs(parameters) {
  ...
  const getTabId = React70.useCallback((tabPanelId) => {
...
function CssAnimation(props) {
  ...
  const hasExited = React81.useRef(true);
  React81.useEffect(() => {
  ...
  const handleAnimationEnd = React81.useCallback((event) => {
...
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React82.useState(!requestedEnter);
  React82.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React82.useCallback((event) => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JBXTDW7W.js.map
