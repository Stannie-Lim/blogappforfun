...
var Badge = React17.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime12.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime11.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React55.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React55.useRef(false);
  const handleEntering = React55.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React55.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React55.useCallback(() => {
    dispatch("exiting");
  }, []);
...
true ? Popup.propTypes = {
   ...
   * @default false
   */
  withTransition: import_prop_types27.default.bool
} : void 0;
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-O4DT22BC.js.map
